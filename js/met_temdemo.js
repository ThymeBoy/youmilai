...
function metTemDemo(){
	...
	if(device_type!='m' && location.href.indexOf('https://show.metinfo.cn/m/mui098/366/public/js/metinfo.cn')>=0 && self == top){
		document.domain='https://show.metinfo.cn/m/mui098/366/public/js/metinfo.cn';// 定义相同域名
		// 网站参数
			...
			var demoFun=function(id){
				...
				$demo_iframe.onload=function(){
					...
					$close_demo_head.addEventListener('click',function() {
						if(demo_iframe==1){
							$html.style.transition='https://show.metinfo.cn/m/mui098/366/public/js/padding-top .5s';
